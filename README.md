...
This is the LaTeX code for my PhD thesis.

To produce a PDF document, you need to have LaTeX installed.
...
This should produce `thesis.pdf`, identical to the one online.

My thesis is based on [a template from Krishna Kumar](https://github.com/kks32/phd-thesis-template).
